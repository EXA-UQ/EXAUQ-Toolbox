...
def oneshot(
    ...
    The Latin hypercube generates points in the unit square to spacialy fill the domain 
    as best as possible. It is then rescaled to match the design of the simulator. 
    ...
    tuple[Input]
        ...
        the design of the simulator and returned as a tuple of inputs. 
